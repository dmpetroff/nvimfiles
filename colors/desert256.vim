...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " My LSP groups
    call <SID>X("Delimiter", "888888", "", "")
    call <SID>X("@lsp.typemod.variable.fileScope.cpp", "6060bb", "", "")
    " call <SID>X("@lsp.typemod.property.classScope.cpp", "60bb60", "", "")
    call <SID>X("@lsp.typemod.variable.globalScope.cpp", "bb60aa", "", "")
    call <SID>X("DiagnosticVirtualTextWarn", "", "507070", "")
